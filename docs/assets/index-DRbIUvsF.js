 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nD(t){t=Tn(t,pt);const e=Tn(t.firestore,Fi);return bN(_f(e),t._key).then(n=>GE(e,t,n))}class qE extends JN{constructor(e){super(),this.firestore=e}convertBytes(e){return new ji(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new pt(this.firestore,null,n)}}function pa(t,e,n){t=Tn(t,pt);const r=Tn(t.firestore,Fi),i=ZN(t.converter,e,n);return KE(r,[qN(WN(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Yt.none())])}function Zg(t){return KE(Tn(t.firestore,Fi),[new nf(t._key,Yt.none())])}function yc(t,...e){var n,r,i;t=tt(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Jg(e[o])||(s=e[o],o++);const l={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Jg(e[o])){const y=e[o];e[o]=(n=y.next)===null||n===void 0?void 0:n.bind(y),e[o+1]=(r=y.error)===null||r===void 0?void 0:r.bind(y),e[o+2]=(i=y.complete)===null||i===void 0?void 0:i.bind(y)}let u,h,f;if(t instanceof pt)h=Tn(t.firestore,Fi),f=Yl(t._key.path),u={next:y=>{e[o]&&e[o](GE(h,t,y))},error:e[o+1],complete:e[o+2]};else{const y=Tn(t,ou);h=Tn(y.firestore,Fi),f=y._query;const v=new qE(h);u={next:I=>{e[o]&&e[o](new eD(h,v,y,I))},error:e[o+1],complete:e[o+2]},XN(t._query)}return function(v,I,N,x){const V=new xE(x),S=new IE(I,V,N);return v.asyncQueue.enqueueAndForget(async()=>EE(await Mh(v),S)),()=>{V.Za(),v.asyncQueue.enqueueAndForget(async()=>TE(await Mh(v),S))}}(_f(h),f,l,u)}function KE(t,e){return function(r,i){const s=new rr;return r.asyncQueue.enqueueAndForget(async()=>RN(await LN(r),i,s)),s.promise}(_f(t),e)}function GE(t,e,n){const r=n.docs.get(e._key),i=new qE(t);return new WE(t,i,e._key,r,new Ss(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){Wi=i})($i),Jt(new zt("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Fi(new iP(r.getProvider("auth-internal")),new lP(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new H(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new lo(h.options.projectId,f)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Ct(gg,"4.7.3",e),Ct(gg,"4.7.3","esm2017")})();const rD={apiKey:"AIzaSyAnBy_07yoc3aTWyfVQmGYZtG6Wu9GXS9E",authDomain:"army-life-web.firebaseapp.com",projectId:"army-life-web",storageBucket:"army-life-web.firebasestorage.app",messagingSenderId:"565006567003",appId:"1:565006567003:web:28e5f359a05bb5bde9617e",measurementId:"G-5NVZZB87MB"},Sf=S_(rD);JC(Sf);const ma=UN(Sf),vc=Ok(Sf),iD=new pn,QE=ie.createContext();function sD(){return ie.useContext(QE)}function oD({children:t}){const[e,n]=ie.useState(null),[r,i]=ie.useState(!0),s=async()=>{try{console.log("開始 Google 登入...");const u=await BR(vc,iD);return console.log("✅ 登入成功!",u.user.displayName),u.user}catch(u){throw console.error("❌ 登入失敗:",u),console.error("錯誤代碼:",u.code),console.error("錯誤訊息:",u.message),u}},o=async()=>{try{await TR(vc)}catch(u){throw console.error("登出失敗:",u),u}};ie.useEffect(()=>(console.log("初始化認證監聽器..."),ER(vc,h=>{h?(console.log("✅ 用戶已登入:",h.displayName,h.email),n(h)):(console.log("❌ 用戶未登入"),n(null)),i(!1)})),[]);const l={currentUser:e,signInWithGoogle:s,signOut:o,loading:r};return k.jsx(QE.Provider,{value:l,children:!r&&t})}function aD(t){const[e,n]=ie.useState([]),[r,i]=ie.useState([]),[s,o]=ie.useState([]),[l,u]=ie.useState(""),[h,f]=ie.useState(365),[y,v]=ie.useState(!0),I=t?Jr(ma,"users",t):null,N=t?gc(ma,"users",t,"diaries"):null,x=t?gc(ma,"users",t,"timeline"):null,V=t?gc(ma,"users",t,"moods"):null;return ie.useEffect(()=>{if(!t){v(!1);return}(async()=>{try{const p=await nD(I);if(p.exists()){const m=p.data();u(m.enlistDate||""),f(m.serviceDuration||365)}}catch(p){console.error("載入用戶資料失敗:",p)}})()},[t]),ie.useEffect(()=>{if(!t){v(!1);return}const w=yc(N,p=>{const m=[];p.forEach(_=>{m.push({id:_.id,..._.data()})}),m.sort((_,A)=>new Date(A.date)-new Date(_.date)),n(m),v(!1)},p=>{console.error("監聽日記失敗:",p),v(!1)});return()=>w()},[t]),ie.useEffect(()=>{if(!t)return;const w=yc(x,p=>{const m=[];p.forEach(_=>{m.push({id:_.id,..._.data()})}),m.sort((_,A)=>new Date(_.date)-new Date(A.date)),i(m)},p=>{console.error("監聽時間軸失敗:",p)});return()=>w()},[t]),ie.useEffect(()=>{if(!t)return;const w=yc(V,p=>{const m=[];p.forEach(_=>{m.push({id:_.id,..._.data()})}),m.sort((_,A)=>new Date(A.date)-new Date(_.date)),o(m)},p=>{console.error("監聽心情失敗:",p)});return()=>w()},[t]),{diaries:e,timelineEvents:r,moods:s,enlistDate:l,serviceDuration:h,loading:y,addDiary:async w=>{if(t)try{await pa(Jr(N,String(w.id)),w)}catch(p){throw console.error("新增日記失敗:",p),p}},deleteDiary:async w=>{if(t)try{await Zg(Jr(N,String(w)))}catch(p){throw console.error("刪除日記失敗:",p),p}},addTimelineEvent:async w=>{if(t)try{await pa(Jr(x,String(w.id)),w)}catch(p){throw console.error("新增時間軸事件失敗:",p),p}},deleteTimelineEvent:async w=>{if(t)try{await Zg(Jr(x,String(w)))}catch(p){throw console.error("刪除時間軸事件失敗:",p),p}},addMood:async w=>{if(t)try{await pa(Jr(V,String(w.id)),w)}catch(p){throw console.error("新增心情記錄失敗:",p),p}},updateEnlistDate:async(w,p=365)=>{if(t)try{await pa(I,{enlistDate:w,serviceDuration:p},{merge:!0}),u(w),f(p)}catch(m){throw console.error("更新入伍日期失敗:",m),m}}}}function lD({onGoogleLogin:t}){return k.jsx("div",{className:"login-container",children:k.jsxs("div",{className:"login-card",children:[k.jsxs("div",{className:"login-header",children:[k.jsx("h1",{children:"我的軍旅生活"}),k.jsx("p",{children:"記錄每一個難忘的時刻"})]}),k.jsxs("div",{className:"login-content",children:[k.jsxs("div",{className:"welcome-text",children:[k.jsx("h2",{children:"歡迎回來"}),k.jsx("p",{children:"使用 Google 帳號登入以開始記錄你的軍旅生活"})]}),k.jsxs("button",{className:"google-login-btn",onClick:t,children:[k.jsxs("svg",{className:"google-icon",viewBox:"0 0 24 24",width:"24",height:"24",children:[k.jsx("path",{fill:"#4285F4",d:"M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"}),k.jsx("path",{fill:"#34A853",d:"M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"}),k.jsx("path",{fill:"#FBBC05",d:"M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"}),k.jsx("path",{fill:"#EA4335",d:"M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"})]}),"使用 Google 登入"]}),k.jsxs("div",{className:"login-features",children:[k.jsxs("div",{className:"feature-item",children:[k.jsx("span",{className:"feature-icon",children:"📝"}),k.jsx("span",{children:"記錄日記"})]}),k.jsxs("div",{className:"feature-item",children:[k.jsx("span",{className:"feature-icon",children:"😊"}),k.jsx("span",{children:"心情追蹤"})]}),k.jsxs("div",{className:"feature-item",children:[k.jsx("span",{className:"feature-icon",children:"⏰"}),k.jsx("span",{children:"時間軸"})]}),k.jsxs("div",{className:"feature-item",children:[k.jsx("span",{className:"feature-icon",children:"📅"}),k.jsx("span",{children:"入伍計數"})]})]})]}),k.jsx("div",{className:"login-footer",children:k.jsx("p",{children:"你的數據將安全地存儲在雲端"})})]})})}function uD({enlistDate:t,serviceDuration:e=365,setEnlistDate:n,onClose:r}){const i=o=>{o.preventDefault();const l=o.target.enlistDate.value,u=parseInt(o.target.serviceDuration.value);l&&n(l,u)},s=()=>{r&&r()};return k.jsx("div",{className:"settings-modal-overlay",onClick:s,children:k.jsx("div",{className:"settings-modal",onClick:o=>o.stopPropagation(),children:k.jsxs("form",{onSubmit:i,className:"settings-form",children:[k.jsx("h2",{children:"⚙️ 設定軍旅資訊"}),k.jsxs("div",{className:"form-group",children:[k.jsx("label",{htmlFor:"enlistDate",children:"入伍日期"}),k.jsx("input",{type:"date",id:"enlistDate",name:"enlistDate",defaultValue:t,required:!0,onClick:o=>o.target.showPicker&&o.target.showPicker()})]}),k.jsxs("div",{className:"form-group",children:[k.jsx("label",{children:"服役天數"}),k.jsxs("select",{name:"serviceDuration",defaultValue:e,children:[k.jsx("option",{value:"120",children:"義務役 (4個月 - 120天)"}),k.jsx("option",{value:"365",children:"一年義務役 (365天)"}),k.jsx("option",{value:"730",children:"兩年義務役 (730天)"}),k.jsx("option",{value:"1095",children:"三年志願役 (1095天)"}),k.jsx("option",{value:"1460",children:"四年志願役 (1460天)"})]})]}),k.jsxs("div",{className:"form-buttons",children:[k.jsx("button",{type:"submit",className:"submit-btn",children:"確定"}),t&&r&&k.jsx("button",{type:"button",onClick:r,className:"cancel-btn",children:"取消"})]})]})})})}function cD({enlistDate:t,serviceDuration:e=365,diaries:n,onOpenSettings:r,onDateSelect:i}){const[s,o]=ie.useState(new Date),[l,u]=ie.useState(new Date),h=m=>{m&&(u(m),i&&i(m))},f=m=>new Date(m.getFullYear(),m.getMonth()+1,0).getDate(),y=m=>new Date(m.getFullYear(),m.getMonth(),1).getDay(),v=()=>{const m=s.getFullYear(),_=s.getMonth(),A=[],C=f(s),T=y(s);for(let pe=0;pe<T;pe++)A.push(null);for(let pe=1;pe<=C;pe++)A.push(new Date(m,_,pe));return A},I=m=>{if(!m)return!1;const _=new Date;return m.getDate()===_.getDate()&&m.getMonth()===_.getMonth()&&m.getFullYear()===_.getFullYear()},N=m=>{if(!m||!t)return!1;const _=new Date(t);return m.getDate()===_.getDate()&&m.getMonth()===_.getMonth()&&m.getFullYear()===_.getFullYear()},x=m=>m?m.getDate()===l.getDate()&&m.getMonth()===l.getMonth()&&m.getFullYear()===l.getFullYear():!1,V=m=>{if(!m||!t)return null;const _=new Date(t);_.setHours(0,0,0,0);const A=new Date(m);A.setHours(0,0,0,0);const C=A-_,T=Math.floor(C/(1e3*60*60*24));return T>=0?T:null},S=()=>{if(!t)return null;const m=V(new Date);if(m===null)return null;const _=e-(m+1);return _>0?_:0},E=m=>{if(!m||!n)return!1;const _=m.getFullYear(),A=m.getMonth(),C=m.getDate();return n.some(T=>{const pe=new Date(T.date);return pe.getFullYear()===_&&pe.getMonth()===A&&pe.getDate()===C})},R=m=>{if(!m||!n)return null;const _=m.getFullYear(),A=m.getMonth(),C=m.getDate(),T=n.find(nn=>{const rn=new Date(nn.date);return rn.getFullYear()===_&&rn.getMonth()===A&&rn.getDate()===C});return T?{happy:"😊",sad:"😢",irritated:"😤",crying:"😭",neutral:"😐",angry:"😡",tired:"😫"}[T.mood]||"😊":null},O=()=>{o(new Date(s.getFullYear(),s.getMonth()-1))},U=()=>{o(new Date(s.getFullYear(),s.getMonth()+1))},F=()=>{const m=new Date;o(m),u(m)},w=["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],p=["日","一","二","三","四","五","六"];return k.jsxs("div",{className:"container calendar-container",children:[k.jsxs("div",{className:"calendar-header-controls",children:[k.jsx("button",{onClick:O,className:"nav-btn",children:"‹"}),k.jsxs("div",{className:"calendar-title",children:[k.jsxs("h2",{children:[s.getFullYear(),"年 ",w[s.getMonth()]]}),k.jsx("button",{onClick:F,className:"today-btn",children:"📍 今天"})]}),k.jsx("button",{onClick:U,className:"nav-btn",children:"›"})]}),t?k.jsxs("div",{className:"calendar-info",children:[k.jsxs("div",{className:"info-items",children:[k.jsxs("div",{className:"info-item",children:[k.jsx("span",{className:"info-icon",children:"🎖️"}),k.jsxs("span",{children:["入伍日期: ",new Date(t).toLocaleDateString("zh-TW")]})]}),k.jsxs("div",{className:"info-item",children:[k.jsx("span",{className:"info-icon",children:"📍"}),k.jsxs("span",{children:["已服役: ",V(new Date)!==null?V(new Date)+1:0," 天"]})]}),k.jsxs("div",{className:"info-item",children:[k.jsx("span",{className:"info-icon",children:"⏳"}),k.jsxs("span",{children:["剩餘: ",S()," 天"]})]})]}),k.jsx("button",{onClick:r,className:"settings-btn",children:"⚙️ 設定"})]}):k.jsxs("div",{className:"calendar-info no-enlist",children:[k.jsx("p",{children:"尚未設定入伍日期"}),k.jsx("button",{onClick:r,className:"settings-btn-large",children:"⚙️ 設定入伍日期"})]}),k.jsxs("div",{className:"calendar-grid",children:[p.map(m=>k.jsx("div",{className:"calendar-day-name",children:m},m)),v().map((m,_)=>{const A=m?V(m):null;return k.jsx("div",{className:`calendar-day ${m?"":"empty"}
                         ${I(m)?"today":""}
                         ${N(m)?"enlist-day":""}
                         ${x(m)?"selected":""}
                         ${A!==null?"service-day":""}
                         ${E(m)?"has-diary":""}`,onClick:()=>h(m),children:m&&k.jsxs(k.Fragment,{children:[k.jsx("div",{className:"day-number",children:m.getDate()}),R(m)&&k.jsx("div",{className:"diary-indicator",children:R(m)}),I(m)&&k.jsx("div",{className:"day-badge today-badge",children:"今"}),N(m)&&k.jsx("div",{className:"day-badge enlist-badge",children:"入伍"}),A!==null&&A>0&&k.jsxs("div",{className:"day-count",children:["D+",A]})]})},_)})]}),l&&k.jsxs("div",{className:"selected-date-info",children:[k.jsx("h3",{children:"選擇的日期"}),k.jsx("p",{className:"selected-date-text",children:l.toLocaleDateString("zh-TW",{year:"numeric",month:"long",day:"numeric",weekday:"long"})}),V(l)!==null&&k.jsxs("p",{className:"service-info",children:["服役第 ",V(l)+1," 天"]})]})]})}const hD=[{emoji:"😊",label:"開心",value:"happy"},{emoji:"😢",label:"難過",value:"sad"},{emoji:"😤",label:"煩躁",value:"irritated"},{emoji:"😭",label:"想哭",value:"crying"},{emoji:"😐",label:"普通",value:"neutral"},{emoji:"😡",label:"生氣",value:"angry"},{emoji:"😫",label:"疲憊",value:"tired"}];function dD({addDiary:t,selectedDate:e}){const[n,r]=ie.useState(""),[i,s]=ie.useState(""),[o,l]=ie.useState(""),u=f=>{if(f.preventDefault(),!n.trim()||!i.trim()||!o)return;const y=e||new Date,v={id:Date.now(),title:n.trim(),content:i.trim(),mood:o,date:y.toISOString()};t(v),r(""),s(""),l("")},h=()=>e?new Date(e).toLocaleDateString("zh-TW",{month:"long",day:"numeric",weekday:"long"}):"今天";return k.jsxs("div",{className:"container diary-form",children:[k.jsxs("h2",{children:["寫日記 - ",h()]}),k.jsxs("form",{onSubmit:u,children:[k.jsxs("div",{className:"mood-selector",children:[k.jsx("label",{children:"今天心情："}),k.jsx("div",{className:"mood-options",children:hD.map(f=>k.jsxs("button",{type:"button",className:`mood-btn ${o===f.value?"selected":""}`,onClick:()=>l(f.value),title:f.label,children:[k.jsx("span",{className:"mood-emoji",children:f.emoji}),k.jsx("span",{className:"mood-label",children:f.label})]},f.value))})]}),k.jsx("input",{type:"text",placeholder:"標題",value:n,onChange:f=>r(f.target.value),required:!0}),k.jsx("textarea",{placeholder:"寫下你今天發生的事情...",value:i,onChange:f=>s(f.target.value),required:!0}),k.jsx("div",{className:"form-buttons",children:k.jsx("button",{type:"submit",children:"發布"})})]})]})}const fD=[{emoji:"😊",label:"開心",value:"happy"},{emoji:"😢",label:"難過",value:"sad"},{emoji:"😤",label:"煩躁",value:"irritated"},{emoji:"😭",label:"想哭",value:"crying"},{emoji:"😐",label:"普通",value:"neutral"},{emoji:"😡",label:"生氣",value:"angry"},{emoji:"😫",label:"疲憊",value:"tired"}];function pD({diaries:t,deleteDiary:e}){const[n,r]=ie.useState(null),[i,s]=ie.useState(null),o=f=>new Date(f).toLocaleString("zh-TW",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}),l=f=>{var y;return((y=fD.find(v=>v.value===f))==null?void 0:y.emoji)||"😊"},u=f=>{e(f),s(null),r(null)},h=f=>{n===f?(r(null),s(null)):(r(f),s(null))};return k.jsxs("div",{className:"container diary-list",children:[k.jsx("h2",{children:"我的日記"}),t.length===0?k.jsx("p",{className:"empty-message",children:"還沒有日記記錄，開始寫下你的第一篇吧！"}):k.jsx("div",{className:"diaries",children:t.map(f=>k.jsxs("div",{className:`diary-item ${n===f.id?"expanded":"collapsed"}`,children:[k.jsxs("div",{className:"diary-header",onClick:()=>h(f.id),children:[k.jsxs("div",{className:"diary-title-row",children:[f.mood&&k.jsx("span",{className:"diary-mood",children:l(f.mood)}),k.jsx("h3",{children:f.title})]}),k.jsx("span",{className:"diary-date-inline",children:o(f.date)}),k.jsx("button",{type:"button",className:"expand-toggle",onClick:y=>{y.stopPropagation(),h(f.id)},children:n===f.id?"▲":"▼"})]}),n===f.id&&k.jsxs(k.Fragment,{children:[k.jsx("p",{className:"diary-content",children:f.content}),k.jsx("div",{className:"diary-actions",children:i===f.id?k.jsxs("div",{className:"delete-confirm",children:[k.jsx("p",{children:"確定要刪除這篇日記嗎？"}),k.jsxs("div",{className:"confirm-buttons",children:[k.jsx("button",{onClick:()=>u(f.id),className:"confirm-delete-btn",children:"確定刪除"}),k.jsx("button",{onClick:()=>s(null),className:"cancel-delete-btn",children:"取消"})]})]}):k.jsx("button",{onClick:()=>s(f.id),className:"delete-btn",children:"🗑️ 刪除日記"})})]})]},f.id))})]})}const mD=[{emoji:"😊",label:"開心",value:"happy"},{emoji:"😢",label:"難過",value:"sad"},{emoji:"😤",label:"煩躁",value:"irritated"},{emoji:"😭",label:"想哭",value:"crying"},{emoji:"😐",label:"普通",value:"neutral"},{emoji:"😡",label:"生氣",value:"angry"},{emoji:"😫",label:"疲憊",value:"tired"}];function gD({selectedDate:t,onClose:e,addDiary:n,existingDiary:r}){const[i,s]=ie.useState(""),[o,l]=ie.useState(""),[u,h]=ie.useState("");ie.useEffect(()=>{r&&(s(r.title),l(r.content),h(r.mood))},[r]);const f=()=>t?new Date(t).toLocaleDateString("zh-TW",{year:"numeric",month:"long",day:"numeric",weekday:"long"}):"",y=I=>{if(I.preventDefault(),!i.trim()||!o.trim()||!u)return;const N={id:(r==null?void 0:r.id)||Date.now(),title:i.trim(),content:o.trim(),mood:u,date:t.toISOString()};n(N),e()},v=()=>{e()};return k.jsx("div",{className:"quick-modal-overlay",onClick:v,children:k.jsxs("div",{className:"quick-modal",onClick:I=>I.stopPropagation(),children:[k.jsxs("div",{className:"quick-modal-header",children:[k.jsx("h2",{children:r?"編輯日記":"快速寫日記"}),k.jsx("p",{className:"quick-modal-date",children:f()}),k.jsx("button",{onClick:e,className:"close-modal-btn",children:"×"})]}),k.jsxs("form",{onSubmit:y,className:"quick-diary-form",children:[k.jsxs("div",{className:"mood-selector",children:[k.jsx("label",{children:"心情："}),k.jsx("div",{className:"mood-options",children:mD.map(I=>k.jsxs("button",{type:"button",className:`mood-btn ${u===I.value?"selected":""}`,onClick:()=>h(I.value),title:I.label,children:[k.jsx("span",{className:"mood-emoji",children:I.emoji}),k.jsx("span",{className:"mood-label",children:I.label})]},I.value))})]}),k.jsx("input",{type:"text",placeholder:"標題",value:i,onChange:I=>s(I.target.value),required:!0,autoFocus:!0}),k.jsx("textarea",{placeholder:"寫下今天發生的事情...",value:o,onChange:I=>l(I.target.value),required:!0,rows:"8"}),k.jsxs("div",{className:"quick-modal-buttons",children:[k.jsx("button",{type:"submit",className:"submit-btn",children:r?"更新":"發布"}),k.jsx("button",{type:"button",onClick:e,className:"cancel-btn",children:"取消"})]})]})]})})}function yD({diaries:t,enlistDate:e}){const n=()=>{if(!e)return null;const h=new Date(e);h.setHours(0,0,0,0);const f=new Date;f.setHours(0,0,0,0);const y=f-h,v=Math.floor(y/(1e3*60*60*24));return v>=0?v+1:0},r={happy:"😊",sad:"😢",irritated:"😤",crying:"😭",neutral:"😐",angry:"😡",tired:"😫"},i={happy:"開心",sad:"難過",irritated:"煩躁",crying:"想哭",neutral:"普通",angry:"生氣",tired:"疲憊"},s={};t.forEach(h=>{h.mood&&(s[h.mood]=(s[h.mood]||0)+1)});const o=Object.keys(s).reduce((h,f)=>s[h]>s[f]?h:f,Object.keys(s)[0]),l=t.length,u=h=>l===0?0:((s[h]||0)/l*100).toFixed(1);return k.jsxs("div",{className:"mood-stats-container",children:[k.jsx("h3",{className:"stats-title",children:"心情統計"}),k.jsxs("div",{className:"stats-summary",children:[e&&n()!==null&&k.jsxs("div",{className:"summary-item",children:[k.jsx("span",{className:"summary-label",children:"已服役天數"}),k.jsxs("span",{className:"summary-value",children:[n()," 天"]})]}),k.jsxs("div",{className:"summary-item",children:[k.jsx("span",{className:"summary-label",children:"總日記數"}),k.jsx("span",{className:"summary-value",children:l})]}),o&&k.jsxs("div",{className:"summary-item",children:[k.jsx("span",{className:"summary-label",children:"最常心情"}),k.jsxs("span",{className:"summary-value",children:[r[o]," ",i[o]]})]})]}),k.jsx("div",{className:"mood-breakdown",children:Object.keys(r).map(h=>{const f=s[h]||0,y=u(h);return f===0?null:k.jsxs("div",{className:"mood-item",children:[k.jsxs("div",{className:"mood-header",children:[k.jsx("span",{className:"mood-emoji",children:r[h]}),k.jsx("span",{className:"mood-name",children:i[h]}),k.jsxs("span",{className:"mood-count",children:[f," 次"]})]}),k.jsx("div",{className:"mood-bar-container",children:k.jsx("div",{className:"mood-bar",style:{width:`${y}%`},"data-mood":h})}),k.jsxs("div",{className:"mood-percentage",children:[y,"%"]})]},h)})}),l===0&&k.jsxs("div",{className:"no-data",children:[k.jsx("p",{children:"還沒有日記記錄"}),k.jsx("p",{className:"no-data-hint",children:"開始記錄你的心情吧！"})]})]})}function vD(){const{currentUser:t,signInWithGoogle:e,signOut:n}=sD(),[r,i]=ie.useState(!1),[s,o]=ie.useState(null),[l,u]=ie.useState(!1),{diaries:h,enlistDate:f,serviceDuration:y,loading:v,addDiary:I,deleteDiary:N,updateEnlistDate:x}=aD(t==null?void 0:t.uid),V=async()=>{try{await e()}catch{alert("登入失敗，請稍後再試")}},S=async()=>{try{await n()}catch{alert("登出失敗，請稍後再試")}};return t?v?k.jsx("div",{className:"app",children:k.jsx("header",{className:"app-header",children:k.jsxs("div",{className:"header-content",children:[k.jsx("h1",{children:"我的軍旅生活"}),k.jsx("p",{children:"載入中..."})]})})}):k.jsxs("div",{className:"app",children:[k.jsx("header",{className:"app-header",children:k.jsxs("div",{className:"header-content",children:[k.jsxs("div",{children:[k.jsx("h1",{children:"我的軍旅生活"}),k.jsx("p",{children:"記錄每一個難忘的時刻"})]}),k.jsxs("div",{className:"user-info",children:[k.jsx("img",{src:t.photoURL,alt:t.displayName,className:"user-avatar"}),k.jsx("span",{className:"user-name",children:t.displayName}),k.jsx("button",{onClick:S,className:"logout-btn",children:"登出"})]})]})}),k.jsx(cD,{enlistDate:f,serviceDuration:y,diaries:h,onOpenSettings:()=>i(!0),onDateSelect:E=>{o(E),u(!0)}}),r&&k.jsx(uD,{enlistDate:f,serviceDuration:y,setEnlistDate:async(E,R)=>{await x(E,R),i(!1)},onClose:()=>i(!1)}),l&&s&&k.jsx(gD,{selectedDate:s,onClose:()=>u(!1),addDiary:I,existingDiary:h.find(E=>{const R=new Date(E.date);return R.getFullYear()===s.getFullYear()&&R.getMonth()===s.getMonth()&&R.getDate()===s.getDate()})}),k.jsxs("div",{className:"main-content",children:[k.jsx(dD,{addDiary:I,selectedDate:s}),k.jsx(pD,{diaries:h,deleteDiary:N}),k.jsx(yD,{diaries:h,enlistDate:f})]})]}):k.jsx(lD,{onGoogleLogin:V})}_c.createRoot(document.getElementById("root")).render(k.jsx($0.StrictMode,{children:k.jsx(oD,{children:k.jsx(vD,{})})}));
